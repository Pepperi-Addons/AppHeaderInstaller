...
class MyService {
    ...
    addOnsToInstall = [
        ...
        {name: 'Cpi node', uuid: 'bb6ee826-1c6b-4a11-9758-40a46acb69c5', ver: '1.5.39', phased: false, release: false}, //wait for qa oleg
        ...
        {name: 'Cpas', uuid: '00000000-0000-0000-0000-0000003eba91', ver: '17.30.5', phased: false, release: false}, //wait for qa oleg
