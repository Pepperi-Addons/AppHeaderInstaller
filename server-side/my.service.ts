...
class MyService {
    ...
    addOnsToInstall = [
       ...
       // {name: 'Local storage', uuid: '5130126c-1c2a-446f-9d08-754269fdaa72', ver: '1.0.1', phased: false, release: false},
        ...
        {name: 'Pages', uuid: '50062e0c-9967-4ed4-9102-f2bc50602d41', ver: '2.0.131', phased: true, release: true}, //done
        {name: 'Gallery2', uuid: '194772e8-1c45-48ee-9401-bea82f0d7c65', ver: '2.0.20', phased: true, release: true}, //done
        {name: 'Slideshow2', uuid: '16d2052b-55b7-43b5-9d3b-a2f9d9950d59', ver: '2.0.41', phased: true, release: true}, //done
        ...
        {name: 'Banner', uuid: '58054aa9-5667-4fbf-9b9a-f9c94cd00906', ver: '0.9.27', phased: true, release: true}, //done
        {name: 'Buttons', uuid: '0eb2627d-2bc2-4d73-9ac6-d5b191cb59a2', ver: '0.0.56', phased: true, release: true}, //done
        {name: 'basic-logic-blocks', uuid: 'a446f8ae-3787-497b-9a92-82e571bdf48e', ver: '1.0.16', phased: true, release: true}, //done
        {name: 'filter block', uuid: 'd00398a6-3b65-47a0-b02c-08f5de960740', ver: '0.5.36', phased: true, release: true}, //done
        {name: 'rich text', uuid: '3864cd44-b388-41c5-8af9-ec200f72b3f3', ver: '1.0.29', phased: true, release: true}, //done
