...
class MyService {
    ...
    addOnsToInstall = [
       ...
       // {name: 'Local storage', uuid: '5130126c-1c2a-446f-9d08-754269fdaa72', ver: '1.0.1', phased: false, release: false},
        ...
        {name: 'Assets Manager', uuid: 'ad909780-0c23-401e-8e8e-f514cc4f6aa2', ver: '1.2.13', phased: true, release: true}, //done
        {name: 'Pages', uuid: '50062e0c-9967-4ed4-9102-f2bc50602d41', ver: '2.0.96', phased: false, release: false}, //Ready on 05/12, do not PHASE
        {name: 'Gallery2', uuid: '194772e8-1c45-48ee-9401-bea82f0d7c65', ver: '2.0.12', phased: false, release: true}, //done
        {name: 'Slideshow2', uuid: '16d2052b-55b7-43b5-9d3b-a2f9d9950d59', ver: '2.0.32', phased: false, release: true}, //done
        {name: 'Themes', uuid: '95501678-6687-4fb3-92ab-1155f47f839e', ver: '2.1.5', phased: false, release: true}, //done
        {name: 'Application Header', uuid: '9bc8af38-dd67-4d33-beb0-7d6b39a6e98d', ver: '0.5.42', phased: false, release: true}, //done
